...
import {
  omnichainExecutorOwnerAddress as omnichainExecutorOwnerAddressString,
...
export const omnichainExecutorOwnerAddress = Address.fromString(
  omnichainExecutorOwnerAddressString,
);
