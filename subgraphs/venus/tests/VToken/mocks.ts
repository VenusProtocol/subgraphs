...
export const createVBep20AndUnderlyingMock = (
  ...
  createMockedFunction(contractAddress, 'borrowRatePerBlock', 'borrowRatePerBlock():(uint256)').returns([ethereum.Value.fromI32(12678493)]);

  createMockedFunction(contractAddress, 'getCash', 'getCash():(uint256)').returns([ethereum.Value.fromUnsignedBigInt(BigInt.fromString('1418171344423412457'))]);

  createMockedFunction(contractAddress, 'exchangeRateStored', 'exchangeRateStored():(uint256)').returns([ethereum.Value.fromUnsignedBigInt(BigInt.fromString('365045823500000000000000'))]);
  ...
  createMockedFunction(contractAddress, 'totalReserves', 'totalReserves():(uint256)').returns([ethereum.Value.fromUnsignedBigInt(BigInt.fromString('5128924555022289393'))]);

  createMockedFunction(contractAddress, 'accrualBlockNumber', 'accrualBlockNumber():(uint256)').returns([ethereum.Value.fromUnsignedBigInt(BigInt.fromString('999'))]);
  ...
  createMockedFunction(contractAddress, 'supplyRatePerBlock', 'supplyRatePerBlock():(uint256)').returns([ethereum.Value.fromI32(12678493)]);

  createMockedFunction(contractAddress, 'decimals', 'decimals():(uint8)').returns([ethereum.Value.fromUnsignedBigInt(BigInt.fromString('18'))]);
  ...
  createMockedFunction(comptrollerAddress, 'closeFactorMantissa', 'closeFactorMantissa():(uint256)').returns([ethereum.Value.fromUnsignedBigInt(BigInt.fromString('10000000000000000'))]);

  createMockedFunction(comptrollerAddress, 'liquidationIncentiveMantissa', 'liquidationIncentiveMantissa():(uint256)').returns([
    ethereum.Value.fromUnsignedBigInt(BigInt.fromString('1000000000000000')),
  ]);

  createMockedFunction(comptrollerAddress, 'maxAssets', 'maxAssets():(uint256)').returns([ethereum.Value.fromUnsignedBigInt(BigInt.fromString('999'))]);

  createMockedFunction(comptrollerAddress, 'venusBorrowState', 'venusBorrowState(address):(uint224,uint32)')
    .withArgs([ethereum.Value.fromAddress(contractAddress)])
    .returns([ethereum.Value.fromI32(999), ethereum.Value.fromI32(999)]);

  createMockedFunction(comptrollerAddress, 'venusSupplyState', 'venusSupplyState(address):(uint224,uint32)')
    .withArgs([ethereum.Value.fromAddress(contractAddress)])
    .returns([ethereum.Value.fromI32(999), ethereum.Value.fromI32(999)]);
};
...
export const createBorrowBalanceCurrentMock = (vTokenAddress: Address, accountAddress: Address, balance: BigInt): void => {
